...
var playerData ={
	...
	states:{
    	...
    	idle:
		{
			...
			frames:
			[
				{width:60, height:55, startX:0, startY:0},
				{width:60, height:55, startX:60, startY:0},
				{width:60, height:55, startX:120, startY:0},
				{width:60, height:55, startX:60, startY:0}
		...
		walk:
		{
			...
			frames:
			[
				{width:60, height:55, startX:180, startY:0},
				{width:60, height:55, startX:240, startY:0},
				{width:60, height:55, startX:300, startY:0},
			]
		},
		//The jump animation 
		jump:
		{
			...
			frames:
			[
				{width:60, height:55, startX:360, startY:0},
				{width:60, height:55, startX:420, startY:0},
				{width:60, height:55, startX:480, startY:0},
				{width:60, height:55, startX:420, startY:0}
			]
		},
		...
		crouch:
		{
			...
			frames:
			[
				{width:60, height:55, startX:60, startY:55},
				{width:60, height:55, startX:120, startY:55},
				{width:60, height:55, startX:180, startY:55},
				{width:60, height:55, startX:120, startY:55}
			]
		},
